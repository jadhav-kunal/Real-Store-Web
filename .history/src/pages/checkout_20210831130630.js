        ...
        <div className="bg-gray-100">
            ...
            <main className="lg:flex max-w-screen-2xl mx-auto">
                ...
                <div className="flex-grow m-5 shadow-sm">
                    <Image
                        src="https://img.freepik.com/free-vector/3d-online-shopping-social-media-mobile-applications-websites-concepts_131114-30.jpg?size=626&ext=jpg&ga=GA1.2.2104465169.1630195200"
                        width={1020}
                        height={250}
                        objectFit="contain"
                    />
