...
const stripePromise = loadStripe(process.env.stripe_public_key); // Environment variable defined by the next.config.js file, for the front
            ...
            <main className="lg:flex max-w-screen-2xl mx-auto">
                ...
                <CSSTransition
                    ...
                    <div className="flex flex-col bg-white p-10 shadow-md">
                        ...
                        <Image
                            src="https://res.cloudinary.com/realstore/image/upload/v1630425733/Realstore/HAPPINESS_IS_NOT_IN_MONEY_BUT_IN_SHOPPING_gqdii7.png"
                            height={1920}
                            width={1080}
                            objectFit="contain"
                        />
